---
title: "01 — Snapshot prodotto Claude Code (aprile 2026)"
slug: 01-snapshot
order: "001"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/01-snapshot.md
---
...
| Mobile | Claude iOS app + [Remote Control](/claude-code/17-ide-surface#remote-control) | Android via mobile web |
...
Cronologia compatta (per dettaglio vedi [19-changelog.md](/claude-code/19-changelog)):
...
← Torna al [README](/claude-code) · Successivo → [02 — CLI e installazione](/claude-code/02-cli-installazione)
