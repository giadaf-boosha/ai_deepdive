---
title: "00b — Context engineering"
slug: 00b-context-engineering
order: "000"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/00b-context-engineering.md
---
---
...
Vedi [06 — CLAUDE.md & memory](/claude-code/06-claude-md-memory).
...
Vedi [06b — Memory architecture](/claude-code/06b-memory-architecture).
...
Dai post X di Boris Cherny (vedi [posts/bcherny.md](/claude-code/bcherny)):
...
- [00 — Harness overview](/claude-code/00-harness-overview) — il livello sopra
- [06 — CLAUDE.md & memory](/claude-code/06-claude-md-memory)
- [06b — Memory architecture](/claude-code/06b-memory-architecture)
- [09 — Skills](/claude-code/09-skills)
- [10 — MCP](/claude-code/10-mcp) sez. 10.6 (tool search)
...
← [00 Harness overview](/claude-code/00-harness-overview) · Successivo → [01 Snapshot](/claude-code/01-snapshot)
