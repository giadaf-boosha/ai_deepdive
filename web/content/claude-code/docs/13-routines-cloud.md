---
title: "13 — Routines (cloud automation)"
slug: 13-routines-cloud
order: "013"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/13-routines-cloud.md
---
...
**Per il deep-dive**: [14 — `/loop` & Monitor](/claude-code/14-loop-monitor) per il loop locale + [14b — Agent loop ReAct](/claude-code/14b-agent-loop-react) per il pattern.
