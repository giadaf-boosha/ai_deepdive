---
title: "18 — Settings & Authentication"
slug: 18-settings-auth
order: "018"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/18-settings-auth.md
---
...
**Per il deep-dive**: [04b — Authority model](/claude-code/04b-authority-model) per i 4 layer di Authority.
...
### Sandbox
Vedi [4 Modalita' permessi § 4.4](/claude-code/04-modalita-permessi#sandbox).
...
Vedi [02 CLI § 2.4](/claude-code/02-cli-installazione#2.4-variabili-d-ambiente-principali).
...
← [17 IDE & surface](/claude-code/17-ide-surface) · Successivo → [19 Changelog](/claude-code/19-changelog)
