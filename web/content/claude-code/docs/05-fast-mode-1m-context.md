---
title: "05 — Fast mode, 1M context, Opus 4.8"
slug: 05-fast-mode-1m-context
order: "005"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/05-fast-mode-1m-context.md
---
...
**Per il deep-dive**: [00b — Context engineering](/claude-code/00b-context-engineering) per come 1M context si combina con tecniche context.
...
Su Opus 4.8 l'effort di **default e' `high`**; `xhigh` (tra `high` e `max`) e' pensato per i task piu' duri. Oltre a questi esiste **`ultracode`** = `xhigh` + orchestrazione workflow automatica (vedi [./24-workflows.md](/claude-code/24-workflows)).
...
| Task duro con workflow automatico | Opus 4.8 + `ultracode` (vedi [./24-workflows.md](/claude-code/24-workflows)) |
...
← [04 Modalita' permessi](/claude-code/04-modalita-permessi) · Successivo → [06 CLAUDE.md e memory](/claude-code/06-claude-md-memory)
