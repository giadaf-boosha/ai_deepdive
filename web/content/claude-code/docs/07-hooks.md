...
slug: 07-hooks
order: "007"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/07-hooks.md
---
...
**Per il deep-dive**: [04b — Authority model § Layer 3](/claude-code/04b-authority-model#layer-3-—-hooks-custom-logic).
...
Il campo `$CLAUDE_EFFORT` e' lo stesso disponibile in [`${CLAUDE_EFFORT}` nelle skill](/claude-code/09-skills) introdotto in v2.1.120 — ora accessibile uniformemente anche negli hook.
...
← [06 CLAUDE.md + memory](/claude-code/06-claude-md-memory) · Successivo → [08 Subagents](/claude-code/08-subagents)
