---
title: "10 — MCP (Model Context Protocol)"
slug: 10-mcp
order: "010"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/10-mcp.md
---
...
**Per il deep-dive**: [11 — Plugins & marketplace](/claude-code/11-plugins-marketplace) per come distribuire server MCP via plugin.
...
← [09 Skills](/claude-code/09-skills) · Successivo → [11 Plugins & Marketplace](/claude-code/11-plugins-marketplace)
