---
title: "15 — Ultraplan & Ultrareview"
slug: 15-ultraplan-ultrareview
order: "015"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/15-ultraplan-ultrareview.md
---
...
**Per il deep-dive**: [15b — Planning strategy](/claude-code/15b-planning-strategy) per quando usare quale livello di planning.
...
← [14 Loop & Monitor](/claude-code/14-loop-monitor) · Successivo → [16 Headless & Agent SDK](/claude-code/16-headless-agent-sdk)
