---
title: "22 — Compound engineering"
slug: 22-compound-engineering
order: "022"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/22-compound-engineering.md
---
---
...
#### S4. Agent teams + mailbox
Per task collaborativi cross-context: team lead + N teammates con mailbox e task list condivisa. Useful per ricerca multi-fonte parallela. Vedi [12 — Agent teams](/claude-code/12-agent-teams).
...
```
Vedi [13 — Routines cloud](/claude-code/13-routines-cloud).
...
Da post X di Boris (vedi [posts/bcherny.md](/claude-code/bcherny)):
...
- Possibilita' di orchestrare **piu' agenti in parallelo** (vedi 22.4 worktree, [docs/12 agent teams](/claude-code/12-agent-teams))
...
> Vedi anche: [00b — Context engineering](/claude-code/00b-context-engineering), 22.1 (definizione operativa) e 22.8 per il case study Kora.
...
- [00 — Harness overview](/claude-code/00-harness-overview) — il livello sotto
- [00b — Context engineering](/claude-code/00b-context-engineering) — il livello tra harness e compound
- [14b — Agent loop ReAct](/claude-code/14b-agent-loop-react) — fondamento del loop
- [21 — Guide per target user](/claude-code/21-guide-target-user) — compound per persona
- [@bcherny — tutti i tip thread](/claude-code/bcherny)
- [Dan Shipper, "Compounding Engineering"](https://every.to/) (citato da Boris)

---

← [21 Guide per target user](/claude-code/21-guide-target-user) · Successivo → [23 Glossario](/claude-code/23-glossario)
