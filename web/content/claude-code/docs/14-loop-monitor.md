---
title: "14 — `/loop` e Monitor tool"
slug: 14-loop-monitor
order: "014"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/14-loop-monitor.md
---
...
**Per il deep-dive**: [14b — Agent loop ReAct](/claude-code/14b-agent-loop-react) per il pattern teorico, [13 — Routines](/claude-code/13-routines-cloud) per il loop in cloud.
...
6. **Per scheduling robusto multi-user / 24/7**: preferisci [Routines (cloud)](/claude-code/13-routines-cloud), `/loop` e' session-scoped.
...
← [13 Routines (cloud)](/claude-code/13-routines-cloud) · Successivo → [15 Ultraplan & Ultrareview](/claude-code/15-ultraplan-ultrareview)
