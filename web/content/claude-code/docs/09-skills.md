...
slug: 09-skills
order: "009"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/09-skills.md
---
...
**Per il deep-dive**: [00b — Context engineering § tecniche](/claude-code/00b-context-engineering) per come le skill ottimizzano il context.
...
| `/loop` | Re-run prompt (vedi [14](/claude-code/14-loop-monitor)) |
...
Da v2.1.157, plugin completi (con `.claude-plugin/plugin.json`) posizionati in `.claude/skills/<nome>/` vengono caricati automaticamente senza richiedere `/plugin install` — vedi [11 — Plugins § auto-loading](/claude-code/11-plugins-marketplace#plugin-locali-auto-loading-e-scaffolding-da-v21157).
...
Vedi sintassi permessi in [18 Settings & Auth](/claude-code/18-settings-auth).
...
Vedi [11 Plugins & Marketplace](/claude-code/11-plugins-marketplace) per installare skill da marketplace ufficiale e community.
...
← [08 Subagents](/claude-code/08-subagents) · Successivo → [10 MCP](/claude-code/10-mcp)
