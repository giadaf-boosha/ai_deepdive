---
title: "11 — Plugins & Marketplace"
slug: 11-plugins-marketplace
order: "011"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/11-plugins-marketplace.md
---
...
**Per il deep-dive**: [09 — Skills](/claude-code/09-skills), [10 — MCP](/claude-code/10-mcp), [07 — Hooks](/claude-code/07-hooks) per i singoli component types.
...
Ogni stdout line → notifica nella sessione (vedi [14 Loop & Monitor](/claude-code/14-loop-monitor)).
...
← [10 MCP](/claude-code/10-mcp) · Successivo → [12 Agent Teams](/claude-code/12-agent-teams)
