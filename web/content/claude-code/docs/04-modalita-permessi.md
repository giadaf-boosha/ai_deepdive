---
title: "04 — Modalita' permessi, Sandbox, Checkpoints"
slug: 04-modalita-permessi
order: "004"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/04-modalita-permessi.md
---
...
**Per il deep-dive**: [04b — Authority model](/claude-code/04b-authority-model) per il framework completo.
...
- Quando il piano e' pronto, dialog con 3 opzioni:
  ...
  2. **No, refine with Ultraplan on Claude Code on the web** (web review piu' profondo, vedi [15](/claude-code/15-ultraplan-ultrareview))
...
← [03 Slash commands](/claude-code/03-slash-commands) · Successivo → [05 Fast mode + 1M context](/claude-code/05-fast-mode-1m-context)
