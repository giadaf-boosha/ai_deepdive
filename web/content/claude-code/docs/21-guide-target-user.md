---
title: "21 — Guide per target user"
slug: 21-guide-target-user
order: "021"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/21-guide-target-user.md
---
...
**Per il deep-dive**: [00 — Harness overview](/claude-code/00-harness-overview) per il framework, [22 — Compound engineering](/claude-code/22-compound-engineering) per i pattern avanzati.
...
- **Sandbox**: ON (default su macOS). Vedi [`docs/04-modalita-permessi.md`](/claude-code/04-modalita-permessi).
...
### Risorse
- [`docs/04-modalita-permessi.md`](/claude-code/04-modalita-permessi) — capire plan mode prima di tutto
- [`docs/17-ide-surface.md`](/claude-code/17-ide-surface) — Desktop app e Web
- [`docs/06-claude-md-memory.md`](/claude-code/06-claude-md-memory) — come funziona CLAUDE.md
- [`docs/20-tips-best-practices.md`](/claude-code/20-tips-best-practices) — Boris: "setup vanilla > customization"
...
### Caso d'uso flagship
**Da issue a PR mergiata in 2 ore.** Issue su GitHub -> `/ultraplan` la legge e produce piano -> CLI esegue il piano -> `/ultrareview` blocca o approva -> autore mergia. Vedi [`docs/15-ultraplan-ultrareview.md`](/claude-code/15-ultraplan-ultrareview).

### Cosa NON fare
1. Non lasciare `/loop` senza idempotenza (vedi [`docs/14-loop-monitor.md`](/claude-code/14-loop-monitor))
2. Non usare fast mode per task brevi: paghi senza guadagnare
3. Non skippare plan mode su refactor cross-file

### Risorse
- [`docs/14-loop-monitor.md`](/claude-code/14-loop-monitor)
- [`docs/13-routines-cloud.md`](/claude-code/13-routines-cloud)
- [`docs/15-ultraplan-ultrareview.md`](/claude-code/15-ultraplan-ultrareview)
- [`docs/05-fast-mode-1m-context.md`](/claude-code/05-fast-mode-1m-context)
...
### Caso d'uso flagship
**Aggiungere un endpoint con full test coverage.** Plan mode -> implementazione service+repository+controller -> integration test con Testcontainers -> security-review -> PR. La GitHub Action gira ultrareview e commenta. Vedi [`docs/16-headless-agent-sdk.md`](/claude-code/16-headless-agent-sdk).

### Cosa NON fare
1. Non auto-mergiare PR generate da AI senza human-in-the-loop
2. Non disattivare sandbox per "velocita'"
3. Non lasciare CLAUDE.md monolitico: usa `@import` per layer (vedi [`docs/06-claude-md-memory.md`](/claude-code/06-claude-md-memory))

### Risorse
- [`docs/18-settings-auth.md`](/claude-code/18-settings-auth) — managed settings Team
- [`docs/07-hooks.md`](/claude-code/07-hooks) — formatter / linter automatici
- [`docs/15-ultraplan-ultrareview.md`](/claude-code/15-ultraplan-ultrareview)
- [`docs/16-headless-agent-sdk.md`](/claude-code/16-headless-agent-sdk) — GitHub Actions
...
### Risorse
- [`docs/17-ide-surface.md`](/claude-code/17-ide-surface) — Computer use, VS Code, Remote Control
- [`docs/14-loop-monitor.md`](/claude-code/14-loop-monitor) — Monitor tool con dev server
- [`docs/09-skills.md`](/claude-code/09-skills)
- [`docs/05-fast-mode-1m-context.md`](/claude-code/05-fast-mode-1m-context)
...
### Caso d'uso flagship
**Postmortem semi-automatico.** Dopo un incident, sessione headless con accesso a logs Datadog (MCP) -> timeline ricostruita -> action items -> documento markdown firmato dal team. Vedi [`docs/13-routines-cloud.md`](/claude-code/13-routines-cloud).
...
### Risorse
- [`docs/13-routines-cloud.md`](/claude-code/13-routines-cloud)
- [`docs/16-headless-agent-sdk.md`](/claude-code/16-headless-agent-sdk)
- [`docs/10-mcp.md`](/claude-code/10-mcp) — MCP per Datadog/AWS/etc
- [`docs/18-settings-auth.md`](/claude-code/18-settings-auth) — Enterprise auth
...
### Risorse
- [`docs/06-claude-md-memory.md`](/claude-code/06-claude-md-memory)
- [`docs/12-agent-teams.md`](/claude-code/12-agent-teams)
- [`docs/18-settings-auth.md`](/claude-code/18-settings-auth)
- [`docs/15-ultraplan-ultrareview.md`](/claude-code/15-ultraplan-ultrareview)
...
### Risorse
- [`docs/05-fast-mode-1m-context.md`](/claude-code/05-fast-mode-1m-context) — 1M context per RAG su contesti lunghi
- [`docs/10-mcp.md`](/claude-code/10-mcp)
- [`docs/16-headless-agent-sdk.md`](/claude-code/16-headless-agent-sdk) — SDK Python/TS
- [`docs/09-skills.md`](/claude-code/09-skills) — skill claude-api
...
> Output style **"Explanatory"** o **"Learning"** consigliato (vedi [`docs/20-tips-best-practices.md § 4`](/claude-code/20-tips-best-practices)): Claude spiega *perche'* il codice legacy fa cio' che fa.
...
### Risorse
- [`docs/06-claude-md-memory.md`](/claude-code/06-claude-md-memory) — `/init` ricco con `CLAUDE_CODE_NEW_INIT=1`
- [`docs/05-fast-mode-1m-context.md`](/claude-code/05-fast-mode-1m-context) — 1M context per source legacy lunghi
- [`docs/04-modalita-permessi.md`](/claude-code/04-modalita-permessi) — plan mode rigoroso
- [`docs/15-ultraplan-ultrareview.md`](/claude-code/15-ultraplan-ultrareview) — design modernizzazione
...
← [20 Tips & best practices](/claude-code/20-tips-best-practices) · Torna al [README](/claude-code)
