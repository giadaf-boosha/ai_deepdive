---
title: "02 — CLI: installazione, comandi, flag"
slug: 02-cli-installazione
order: "002"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/02-cli-installazione.md
---
...
**Per il deep-dive**: [00 — Harness overview](/claude-code/00-harness-overview) per capire perche' una CLI e' una scelta architetturale, non solo un'interfaccia.
...
← [01 Snapshot](/claude-code/01-snapshot) · Successivo → [03 Slash commands](/claude-code/03-slash-commands)
