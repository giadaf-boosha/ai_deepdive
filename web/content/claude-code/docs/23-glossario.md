...
slug: 23-glossario
order: "023"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/23-glossario.md
---
...
**Appare in**: [00](/claude-code/00-harness-overview), [12](/claude-code/12-agent-teams), [16](/claude-code/16-headless-agent-sdk), [21](/claude-code/21-guide-target-user).
...
**Appare in**: [14b](/claude-code/14b-agent-loop-react), [14](/claude-code/14-loop-monitor).
...
**Appare in**: [12](/claude-code/12-agent-teams).
...
**Appare in**: [16](/claude-code/16-headless-agent-sdk).
...
**Appare in**: [04b](/claude-code/04b-authority-model), [04](/claude-code/04-modalita-permessi), [07](/claude-code/07-hooks), [18](/claude-code/18-settings-auth).
...
**Appare in**: [04](/claude-code/04-modalita-permessi), [04b](/claude-code/04b-authority-model).
...
**Appare in**: [06](/claude-code/06-claude-md-memory), [06b](/claude-code/06b-memory-architecture), [00b](/claude-code/00b-context-engineering).
...
**Appare in**: [04](/claude-code/04-modalita-permessi) sez. 4.5, [06b](/claude-code/06b-memory-architecture) Layer 4.
...
**Appare in**: [22](/claude-code/22-compound-engineering).
...
**Appare in**: [00b](/claude-code/00b-context-engineering).
...
**Appare in**: [05](/claude-code/05-fast-mode-1m-context).
...
**Appare in**: [00](/claude-code/00-harness-overview), [14b](/claude-code/14b-agent-loop-react), [07](/claude-code/07-hooks).
...
**Appare in**: [17](/claude-code/17-ide-surface).
...
**Appare in**: [24](/claude-code/24-workflows).
...
**Appare in**: [13](/claude-code/13-routines-cloud), [22](/claude-code/22-compound-engineering).
...
**Appare in**: [03](/claude-code/03-slash-commands), [05](/claude-code/05-fast-mode-1m-context).
...
**Appare in**: [25](/claude-code/25-goal).
...
**Appare in**: [04b](/claude-code/04b-authority-model), [22](/claude-code/22-compound-engineering).
...
**Appare in**: [00](/claude-code/00-harness-overview), [22](/claude-code/22-compound-engineering).
...
**Appare in**: [07](/claude-code/07-hooks), [04b](/claude-code/04b-authority-model).
...
**Appare in**: [00](/claude-code/00-harness-overview), tutti i `0Nb` capitoli.
...
**Appare in**: [00](/claude-code/00-harness-overview), [06](/claude-code/06-claude-md-memory).
...
**Appare in**: [14](/claude-code/14-loop-monitor), [22](/claude-code/22-compound-engineering).
...
**Appare in**: [18](/claude-code/18-settings-auth), [04b](/claude-code/04b-authority-model).
...
**Appare in**: [10](/claude-code/10-mcp).
...
**Appare in**: [06](/claude-code/06-claude-md-memory), [06b](/claude-code/06b-memory-architecture), [00](/claude-code/00-harness-overview).
...
**Appare in**: [14](/claude-code/14-loop-monitor), [14b](/claude-code/14b-agent-loop-react).
...
**Appare in**: [04](/claude-code/04-modalita-permessi) sez. 4.2, [15b](/claude-code/15b-planning-strategy).
...
**Appare in**: [15b](/claude-code/15b-planning-strategy), [00](/claude-code/00-harness-overview).
...
**Appare in**: [11](/claude-code/11-plugins-marketplace).
...
**Appare in**: [00b](/claude-code/00b-context-engineering), [22](/claude-code/22-compound-engineering).
...
**Appare in**: [14b](/claude-code/14b-agent-loop-react).
...
**Appare in**: [13](/claude-code/13-routines-cloud).
...
**Appare in**: [04](/claude-code/04-modalita-permessi) sez. 4.4, [04b](/claude-code/04b-authority-model).
...
**Sinonimi**: `SKILL.md`.
**Appare in**: [09](/claude-code/09-skills).
...
**Appare in**: [08](/claude-code/08-subagents).
...
**Appare in**: [15](/claude-code/15-ultraplan-ultrareview), [15b](/claude-code/15b-planning-strategy).
...
**Appare in**: [15](/claude-code/15-ultraplan-ultrareview).
...
| Pilastro | Capitoli |
|---|---|
| **Intent** | [00](/claude-code/00-harness-overview), [06](/claude-code/06-claude-md-memory), [15b](/claude-code/15b-planning-strategy) |
| **Memory** | [06](/claude-code/06-claude-md-memory), [06b](/claude-code/06b-memory-architecture), [00b](/claude-code/00b-context-engineering) |
| **Planning** | [15](/claude-code/15-ultraplan-ultrareview), [15b](/claude-code/15b-planning-strategy), [04](/claude-code/04-modalita-permessi) sez. plan mode |
| **Authority** | [04](/claude-code/04-modalita-permessi), [04b](/claude-code/04b-authority-model), [07](/claude-code/07-hooks), [18](/claude-code/18-settings-auth) |
| **Control flow** | [14](/claude-code/14-loop-monitor), [14b](/claude-code/14b-agent-loop-react), [07](/claude-code/07-hooks) |
...
← [22 Compound engineering](/claude-code/22-compound-engineering) · Torna al [README](/claude-code)
