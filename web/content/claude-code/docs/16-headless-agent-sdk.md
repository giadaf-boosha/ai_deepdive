---
title: "16 — Headless & Agent SDK"
slug: 16-headless-agent-sdk
order: "016"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/16-headless-agent-sdk.md
---
...
**Per il deep-dive**: [00 — Harness overview](/claude-code/00-harness-overview) per quando usare CC vs SDK leggero.
...
`/install-github-app` setup integrato. Code Review (PR agents) GA su Team/Enterprise (vedi [15](/claude-code/15-ultraplan-ultrareview#code-review-pr-agents---feature-correlata)).
...
← [15 Ultraplan & Ultrareview](/claude-code/15-ultraplan-ultrareview) · Successivo → [17 IDE & surface](/claude-code/17-ide-surface)
