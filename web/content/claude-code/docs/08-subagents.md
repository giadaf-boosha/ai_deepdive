...
slug: 08-subagents
order: "008"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/08-subagents.md
---
...
**Per il deep-dive**: [12 — Agent teams](/claude-code/12-agent-teams) per il livello successivo (multi-agent persistenti) + [00b — Context engineering § Subagent Explore](/claude-code/00b-context-engineering).
...
### Skill come subagent
Skill con `context: fork` + `agent: Explore` → il body della skill diventa task di un subagent (vedi [09 Skills](/claude-code/09-skills)).
...
Approfondimento Agent Teams: [12](/claude-code/12-agent-teams).
...
← [07 Hooks](/claude-code/07-hooks) · Successivo → [09 Skills](/claude-code/09-skills)
