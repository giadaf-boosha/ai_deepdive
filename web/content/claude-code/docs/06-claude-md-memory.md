---
title: "06 — CLAUDE.md, rules, auto-memory"
slug: 06-claude-md-memory
order: "006"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/06-claude-md-memory.md
---
...
**Per il deep-dive**: [06b — Memory architecture](/claude-code/06b-memory-architecture) per i 5 layer di memory + [00b — Context engineering](/claude-code/00b-context-engineering) per le tecniche di context.
...
Cosa caricare e' deciso dal motore di context engineering, non da te (vedi anche [Skills paths frontmatter](/claude-code/09-skills#paths)).
...
← [05 Fast mode + 1M context](/claude-code/05-fast-mode-1m-context) · Successivo → [07 Hooks](/claude-code/07-hooks)
