---
title: "06b — Memory architecture"
slug: 06b-memory-architecture
order: "006"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/06b-memory-architecture.md
---
---
...
> Tutti **concatenati** (non override). Vedi [06 — CLAUDE.md & memory](/claude-code/06-claude-md-memory) sez. 6.2.
...
Vedi [09 — Skills](/claude-code/09-skills).

---

## 06b.7 Letture di approfondimento

- [06 — CLAUDE.md & memory](/claude-code/06-claude-md-memory) — reference operational
- [00 — Harness overview](/claude-code/00-harness-overview) sez. 0.7 — Memory in IMPACT
- [00b — Context engineering](/claude-code/00b-context-engineering) sez. 4 — auto-memory tecnica
- [04 — Modalita' permessi](/claude-code/04-modalita-permessi) sez. 4.5 — checkpoints
- [12 — Agent teams](/claude-code/12-agent-teams) — task list condivisa
- `_research/dossier-conceptual-context.md` — dossier interno

---

← [06 CLAUDE.md & memory](/claude-code/06-claude-md-memory) · Successivo → [07 Hooks](/claude-code/07-hooks)
