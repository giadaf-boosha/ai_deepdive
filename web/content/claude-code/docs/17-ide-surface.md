---
title: "17 — IDE e altre surface"
slug: 17-ide-surface
order: "017"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/17-ide-surface.md
---
...
**Per il deep-dive**: [01 — Snapshot § 1.2 Surface](/claude-code/01-snapshot#12-surface---dove-si-usa-claude-code).
...
### Cosa gira in cloud
- Routines (vedi [13](/claude-code/13-routines-cloud))
- Ultraplan (vedi [15](/claude-code/15-ultraplan-ultrareview))
- Ultrareview (vedi [15](/claude-code/15-ultraplan-ultrareview))
- Cloud Auto-Fix PR (vedi [13](/claude-code/13-routines-cloud#13.10-esempi-pratici))
...
Vedi [10 MCP § 10.8 Channels](/claude-code/10-mcp#10.8-channels-research-preview).

---

## 17.9 GitHub Actions / GitLab CI/CD

`/install-github-app` per setup. Vedi anche [16 Headless](/claude-code/16-headless-agent-sdk#16.3-github-actions-ci) per pipeline esempi.
...
**Quando usarlo**: se gestisci 5+ agenti paralleli quotidianamente e l'overhead di tmux/terminale ti costa tempo. La CLI nativa con `claude --worktree` (vedi [02 § flag worktree](/claude-code/02-cli-installazione)) e' sufficiente per la maggior parte degli usi.
...
| `claude-code-skills` (daymade) | Marketplace community skill | Vedi [11 § marketplace community](/claude-code/11-plugins-marketplace) |
| `claude-skills` (alirezarezvani) | 232+ skill community | Vedi [11 § marketplace community](/claude-code/11-plugins-marketplace) |
| `ccc-skills` (ooiyeefei) | Skill custom Excalidraw architecture diagrams | Vedi [09 § esempio Excalidraw](/claude-code/09-skills) |

> Per skill ufficiali vedi [11 § marketplace ufficiale](/claude-code/11-plugins-marketplace). Per il pattern community piu' generale, vedi [22 § community patterns](/claude-code/22-compound-engineering).
...
← [16 Headless & Agent SDK](/claude-code/16-headless-agent-sdk) · Successivo → [18 Settings & Auth](/claude-code/18-settings-auth)
