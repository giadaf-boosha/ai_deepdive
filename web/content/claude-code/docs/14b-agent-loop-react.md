---
title: "14b — Agent loop e ReAct pattern"
slug: 14b-agent-loop-react
order: "014"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/14b-agent-loop-react.md
---
---
...
5 step ognuno con loop ReAct interno. **Compound engineering** (vedi [22](/claude-code/22-compound-engineering)).
...
| Variante | Quando | Doc |
|---|---|---|
| Bash + auto mode | One-shot, tu sei al PC | [04](/claude-code/04-modalita-permessi) |
| `/loop` cron | Ricorrente periodica | [14](/claude-code/14-loop-monitor) |
| `/loop` self-paced | Claude decide cadenza | [14](/claude-code/14-loop-monitor) |
| Monitor tool | Eventi async (logs, CI) | [14](/claude-code/14-loop-monitor) |
| Routines | 24/7 cloud, no laptop | [13](/claude-code/13-routines-cloud) |
| `/ultraplan` | Pianificazione cloud-scale | [15](/claude-code/15-ultraplan-ultrareview) |
...
**Quando NON usarlo**: feature design, task creativi, cambi su shared infra prod (blast radius alto + verification debole). Per quelli, [`/ultraplan`](/claude-code/15-ultraplan-ultrareview) e' la scelta giusta.
...
- [14 — `/loop` e Monitor tool](/claude-code/14-loop-monitor) — reference operational
- [13 — Routines cloud](/claude-code/13-routines-cloud) — loop in cloud
- [15 — Ultraplan & Ultrareview](/claude-code/15-ultraplan-ultrareview) — loop multi-agent
- [00 — Harness overview](/claude-code/00-harness-overview) sez. 0.4 — Control flow in IMPACT
- [22 — Compound engineering](/claude-code/22-compound-engineering) — composizione di loop
- `_research/dossier-conceptual-react.md` — dossier interno

---

← [14 `/loop` & Monitor](/claude-code/14-loop-monitor) · Successivo → [15 Ultraplan & Ultrareview](/claude-code/15-ultraplan-ultrareview)
