---
title: "04b — Authority model"
slug: 04b-authority-model
order: "004"
source: https://github.com/giadaf-boosha/claude-code/blob/main/docs/04b-authority-model.md
---
---
...
**Vedi**: [04 — Modalita' permessi](/claude-code/04-modalita-permessi) sez. 4.1, [18 — Settings & auth](/claude-code/18-settings-auth) sez. 18.3.
...
**Vedi**: [04 — Modalita' permessi](/claude-code/04-modalita-permessi) sez. 4.4.
...
**Vedi**: [07 — Hooks](/claude-code/07-hooks).
...
**Vedi**: [18 — Settings & auth](/claude-code/18-settings-auth) sez. 18.1.
...
[Auto mode](/claude-code/04-modalita-permessi#43-auto-mode-research-preview-da-v2183) e' una **automazione del Layer 1**: invece di chiedere all'utente, un classifier model decide se l'azione e' "safe" o "risky".
...
- [04 — Modalita' permessi, Sandbox, Checkpoints](/claude-code/04-modalita-permessi) — reference operational
- [07 — Hooks](/claude-code/07-hooks) — Layer 3 in dettaglio
- [18 — Settings & auth](/claude-code/18-settings-auth) — Layer 4 e gerarchia settings
- [00 — Harness overview](/claude-code/00-harness-overview) sez. 0.7 — mapping completo
- [21 — Guide per target user](/claude-code/21-guide-target-user) — Authority per persona

---

← [04 Modalita' permessi](/claude-code/04-modalita-permessi) · Successivo → [05 Fast mode + 1M context](/claude-code/05-fast-mode-1m-context)
