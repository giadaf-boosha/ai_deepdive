...
- Generalizzare richiede piu' leve insieme: architettura adatta al dominio, decadimento del peso, dropout — ma gli esempi ostili mostrano che la robustezza resta un problema aperto.
